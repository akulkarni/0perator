...
App templates use Go's `embed` package to bundle files that are copied into generated apps.

### Directory Structure

```
internal/templates/
  templates.go              # //go:embed directive and WriteAppTemplates function
  app/
    CLAUDE.md               # Project guide for generated apps
    src/styles/globals.css  # Tailwind CSS with shadcn theming
```

### Usage

```go
// Copy all app templates to the generated project
templates.WriteAppTemplates(projectPath)
```
